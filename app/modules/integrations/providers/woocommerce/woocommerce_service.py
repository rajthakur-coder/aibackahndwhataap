...
from .woocommerce_schema import WOOCOMMERCE_STATUSES, WoocommerceConnectRequest, WoocommerceDisconnectRequest
...
def _normalize_status(status: str | None) -> str:
    ...
    if value not in WOOCOMMERCE_STATUSES:
...
async def list_woocommerce_connections(db: AsyncSession, tenant_id: str) -> dict:
