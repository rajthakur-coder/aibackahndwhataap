...
def generate_ai_reply(
    ...
    if brand_prompt:
        ...
        system_prompt = (
            ...
            "Only answer questions about this business, its products, orders, delivery, returns, policies, offers, and support. "
            "Do not answer coding, programming, homework, general knowledge, news, or unrelated questions. "
            "For unrelated questions, say you can help only with this business's products, orders, delivery, returns, and support. "
